# Awesome-world-model-robot-learning
...
- LLM-grounded Diffusion: Enhancing Prompt Understanding of Text-to-Image Diffusion Models with Large Language Models. [[code]](https://github.com/TonyLianLong/LLM-groundedDiffusion)
